...
function srnn.units.getLSTMPUnit(inputSize, outputSize, layers, dropout)
	...
	for i = 1, layers do
		...
		local next_out = nn.Linear(outputSize, outputSize, false)(nn.CMulTable()({o_gate, nn.Tanh()(next_cell)}))
